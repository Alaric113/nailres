...
const PortfolioGalleryPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] pt-16 md:pt-24 lg:pt-32 pb-20">
      <header className="py-8 bg-white/50 backdrop-blur-sm shadow-sm sticky top-16 z-20">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {categories.map(cat => (
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-base font-medium transition-all duration-300 transform active:scale-95
              ...
              <div key={item.id} className="group bg-white rounded-2xl shadow-sm border border-[#EFECE5] overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <div className="p-5 flex flex-col gap-3">
                  ...
                  <button 
                    ...
                    className="w-full mt-2 py-2.5 px-4 bg-[#2C2825] text-white text-sm font-bold rounded-xl opacity-90 hover:opacity-100 hover:shadow-lg active:scale-95 transition-all flex items-center justify-center gap-2"
                  >
                    <span>立即預約此款</span>
