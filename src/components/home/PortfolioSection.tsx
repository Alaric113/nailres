...
const PortfolioSection: React.FC<PortfolioSectionProps> = ({ beforeAfter, galleryImages, isLoading }) => {
  return (
    <section id="portfolio" className="min-h-screen py-20 bg-secondary text-text-main snap-start snap-always flex flex-col justify-center relative overflow-hidden">
